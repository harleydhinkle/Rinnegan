...
public class CommandReRollKg extends ElementsNarutomodMod.ModElement {
    public CommandReRollKg(ElementsNarutomodMod instance) {super(instance,3248);}
    ...
    public static class CommandHandler implements ICommand {
        ...
        public void execute(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            });
            {
                ...
                ProcedureReRollKg.executeProcedure($_dependencies);
            }
        }
    }
