...
public class ItemBakuton extends ElementsNarutomodMod.ModElement {
	...
	public static class RangedItem extends ItemJutsu.Base {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
			...
			if (!(player.isCreative() || (ProcedureUtils.hasItemInInventory(player, ItemDoton.block)
			 && ProcedureUtils.hasItemInInventory(player, ItemRaiton.block)))) {
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add(TextFormatting.GREEN
				+ net.minecraft.util.text.translation.I18n.translateToLocal("tooltip.bakuton.musthave")
