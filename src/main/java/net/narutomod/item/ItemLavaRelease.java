...
public class ItemLavaRelease extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:lava_release")
	...
	public ItemLavaRelease(ElementsNarutomodMod instance) {
		super(instance, 592);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemYooton.RangedItem(ROCKS, STREAM, CHAKRAMODE, QUICKLIME));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:lava_release", "inventory"));
	}
	...
	public static class RangedItem extends ItemJutsu.Base {
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			...
			this.setUnlocalizedName("lava_release");
			this.setRegistryName("lava_release");
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add(TextFormatting.GREEN + net.minecraft.util.text.translation.I18n.translateToLocal("tooltip.lava_release.musthave") + TextFormatting.RESET);
		}
