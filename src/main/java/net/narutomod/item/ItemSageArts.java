...
public class ItemSageArts extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:sage_arts")
	...
	public static final ItemJutsu.JutsuEnum SAGEMODE = new ItemJutsu.JutsuEnum(0, "tooltip.sage_arts.sagemode", 'S', 10d, new SageMode());
	public static final ItemJutsu.JutsuEnum RASENGAN = new ItemJutsu.JutsuEnum(1, "tooltip.sage_arts.rasengan", 'S', ItemNinjaArts.RASENGAN.chakraUsage, new EntityRasengan.EC.SageModeVariant());
	public static final ItemJutsu.JutsuEnum RASENSHURIKEN = new ItemJutsu.JutsuEnum(2, "tooltip.sage_arts.rasenshuriken", 'S', ItemWindRelease.RASENSHURIKEN.chakraUsage, new EntityRasenshuriken.EC.SageModeVairant());
	...
	public ItemSageArts(ElementsNarutomodMod instance) {
		super(instance, 710);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemSenjutsu.RangedItem(SAGEMODE, RASENGAN, RASENSHURIKEN, WOODBUDDHA, SNAKE8H, GAMARINSHO));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:sage_arts", "inventory"));
	}
	...
	public static class RangedItem extends ItemJutsu.Base implements ItemOnBody.Interface {
		...
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			...
			this.setUnlocalizedName("sage_arts");
			this.setRegistryName("sage_arts");
		...
		public void onUpdate(ItemStack itemstack, World world, Entity entity, int par4, boolean par5) {
			...
			if (!world.isRemote && entity instanceof EntityLivingBase) {
				...
				if (entity.ticksExisted % 40 == 5 && entity instanceof EntityPlayer) {
					ItemStack stack1 = ProcedureUtils.getMatchingItemStack ((EntityPlayer)entity, ItemNinjaArts.block);
					this.enableJutsu(itemstack, RASENGAN,
					 stack1 != null && sageType == Type.TOAD && ((ItemNinjaArts.RangedItem)stack1.getItem()).canUseJutsu(stack1, ItemNinjaArts.RASENGAN, living));
					stack1 = ProcedureUtils.getMatchingItemStack((EntityPlayer)entity, ItemWindRelease.block);
					this.enableJutsu(itemstack, RASENSHURIKEN,
					 stack1 != null && sageType == Type.TOAD && ((ItemWindRelease.RangedItem)stack1.getItem()).canUseJutsu(stack1, ItemWindRelease.RASENSHURIKEN, living));
					stack1 = ProcedureUtils.getMatchingItemStack((EntityPlayer)entity, ItemWoodRelease.block);
					this.enableJutsu(itemstack, WOODBUDDHA,
					 stack1 != null && sageType== Type.SLUG && ((ItemWoodRelease.ItemCustom)stack1.getItem()).canUseJutsu(stack1, ItemWoodRelease.GOLEM, living));
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			if (jutsu == SAGEMODE && res.getType() == EnumActionResult.SUCCESS && !world.isRemote) {
				if (EntityBijuManager.cloakLevel(entity) > 0 && EntityBijuManager.getCloakXp(entity, 1) < 800) {
					entity.sendStatusMessage(new TextComponentTranslation("chattext.sage_arts.denied", 
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			if (type != Type.NONE) {
				list.add(TextFormatting.BLUE + new TextComponentTranslation("tooltip.sage_arts.type").getUnformattedComponentText()
