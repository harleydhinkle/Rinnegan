...
public class ItemWindRelease extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:wind_release")
	...
	public ItemWindRelease(ElementsNarutomodMod instance) {
		super(instance, 376);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemFuton.RangedItem(CHAKRAFLOW, RASENSHURIKEN, VACUUMS, BIGBLOW, WINDBLADE, VACWAVE));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:wind_release", "inventory"));
	}
	...
	public static class RangedItem extends ItemJutsu.Base {
		...
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			...
			this.setUnlocalizedName("wind_release");
			this.setRegistryName("wind_release");
		...
		public void onUpdate(ItemStack itemstack, World world, Entity entity, int par4, boolean par5) {
			...
			if (!world.isRemote && entity instanceof EntityPlayer && entity.ticksExisted % 10 == 3) {
				...
				boolean rasenganEnabled = stack1 != null && ((ItemNinjaArts.RangedItem)stack1.getItem())
				 .canActivateJutsu(stack1, ItemNinjaArts.RASENGAN, (EntityPlayer)entity) == EnumActionResult.SUCCESS;
