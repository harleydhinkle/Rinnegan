...
public class ItemNinjaArts extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:ninja_arts")
	...
	public static final ItemJutsu.JutsuEnum AMENOTEJIKARA = new ItemJutsu.JutsuEnum(4, "item.ninja_arts.amenotejikara", 'S', 50d, new Amenotejikara());
	public static final ItemJutsu.JutsuEnum PUPPET = new ItemJutsu.JutsuEnum(5, "tooltip.ninja_arts.puppetjutsu", 'C', 0.5d, new EntityPuppet.Base.Jutsu());
	public static final ItemJutsu.JutsuEnum BUGSWARM = new ItemJutsu.JutsuEnum(6, "bugball", 'C', 100d, new EntityKikaichu.EC.Jutsu());
	public static final ItemJutsu.JutsuEnum INVISABILITY = new ItemJutsu.JutsuEnum(7, "tooltip.ninja_arts.hidingincamouflage", 'A', 100d, new HidingWithCamouflage());
	...
	public ItemNinjaArts(ElementsNarutomodMod instance) {
		super(instance, 377);
	}
	
	@Override
	public void initElements() {
		elements.items.add(() -> new ItemNinjutsu.RangedItem(REPLACEMENT, KAGEBUNSHIN, RASENGAN, LIMBOCLONE, AMENOTEJIKARA, PUPPET, BUGSWARM, INVISABILITY, TRANSFORM, HIRAISHIN, SHIKIGAMI, MULTICLONE));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:ninja_arts", "inventory"));
	}
	...
	public static class RangedItem extends ItemJutsu.Base {
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			...
			this.setUnlocalizedName("ninja_arts");
			this.setRegistryName("ninja_arts");
