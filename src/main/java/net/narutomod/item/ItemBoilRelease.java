...
public class ItemBoilRelease extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:boil_release")
	...
	public ItemBoilRelease(ElementsNarutomodMod instance) {
		super(instance, 600);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemFutton.RangedItem(MIST, STRENGTH));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:boil_release", "inventory"));
	}

	public static class RangedItem extends ItemJutsu.Base {
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			super(ItemJutsu.JutsuEnum.Type.FUTTON, list);
			this.setUnlocalizedName("boil_release");
			this.setRegistryName("boil_release");
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add(TextFormatting.GREEN + net.minecraft.util.text.translation.I18n.translateToLocal("tooltip.boil_release.musthave") + TextFormatting.RESET);
		}
	}
