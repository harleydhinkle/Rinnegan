...
public class ItemYangRelease extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:yang_release")
	...
	public ItemYangRelease(ElementsNarutomodMod instance) {
		super(instance, 406);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemYoton.RangedItem(MULTISIZE, FUUIN, SEALINGCHAIN, SEALING9D, SEALING10));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:yang_release", "inventory"));
	...
	public static class RangedItem extends ItemJutsu.Base {
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			...
			this.setUnlocalizedName("yang_release");
			this.setRegistryName("yang_release");
