...
public class ItemScorchRelease extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:scorch_release")
	...
	public static final ItemJutsu.JutsuEnum SHOOT = new ItemJutsu.JutsuEnum(1, "tooltip.scorch_release.scorchkill", 'S', 200, 50d, new SetOrbTarget());
	public static final ItemJutsu.JutsuEnum BLAST = new ItemJutsu.JutsuEnum(2, "tooltip.scorch_release.scorchblast", 'S', 250, 50d, new SuperSteamBlast());

	public ItemScorchRelease(ElementsNarutomodMod instance) {
		super(instance, 589);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemShakuton.RangedItem(ORB, SHOOT, BLAST));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:scorch_release", "inventory"));
	}
	...
	public static class RangedItem extends ItemJutsu.Base {
		...
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			...
			setUnlocalizedName("scorch_release");
			setRegistryName("scorch_release");
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			if (entity.isCreative() || (ProcedureUtils.hasItemInInventory(entity, ItemWindRelease.block) 
			 && ProcedureUtils.hasItemInInventory(entity, ItemFireRelease.block))) {
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add(TextFormatting.GREEN + net.minecraft.util.text.translation.I18n.translateToLocal("tooltip.scorch_release.musthave") + TextFormatting.RESET);
		}
	}
	...
	public static class EntityScorchBall extends EntityScalableProjectile.Base implements ItemJutsu.IJutsu {
		...
		public void setNextPosition(Vec3d vec) {
			if (this.getDistance(vec.x, vec.y, vec.z) > 0.5d && this.targetTime >= 0) {
				this.setVelocity(vec.subtract(this.getPositionVector()).normalize().scale(1.5d));
			} else {
