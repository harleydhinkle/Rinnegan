...
public class ItemMedicalNinjutsu extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:medical_ninjutsu")
	...
	public ItemMedicalNinjutsu(ElementsNarutomodMod instance) {
		super(instance, 523);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemIryoJutsu.RangedItem(HEALING, POISONMIST, MEDMODE, POWERMODE));
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:medical_ninjutsu", "inventory"));
	}

	public static class RangedItem extends ItemJutsu.Base {
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			super(ItemJutsu.JutsuEnum.Type.IRYO, list);
			this.setUnlocalizedName("medical_ninjutsu");
			this.setRegistryName("medical_ninjutsu");
