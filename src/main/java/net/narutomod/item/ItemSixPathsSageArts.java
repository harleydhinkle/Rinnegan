...
public class ItemSixPathsSageArts extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:six_paths_sage_arts")
	...
	public ItemSixPathsSageArts(ElementsNarutomodMod instance) {
		super(instance, 703);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemSixPathSenjutsu.RangedItem(SHOOT, SHIELD, THUNDER, LASER, RASENSHURIKEN));
	}

	@Override
	@SideOnly(Side.CLIENT)
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:six_paths_sage_arts", "inventory"));
	}
	...
	public static class RangedItem extends ItemJutsu.Base {
		...
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			...
			this.setUnlocalizedName("six_paths_sage_arts");
			this.setRegistryName("six_paths_sage_arts");
		...
		public void onUpdate(ItemStack itemstack, World world, Entity entity, int par4, boolean par5) {
			...
			if (entity instanceof EntityLivingBase && !world.isRemote) {
				...
				if (entity.ticksExisted % 40 == 5 && entity instanceof EntityPlayer) {
					ItemStack stack1 = ProcedureUtils.getMatchingItemStack((EntityPlayer)entity, ItemWindRelease.block);
					this.enableJutsu(itemstack, RASENSHURIKEN,
					 stack1 != null && ((ItemWindRelease.RangedItem)stack1.getItem()).canUseJutsu(stack1, ItemWindRelease.RASENSHURIKEN, livingEntity));
				}
			}
		}
