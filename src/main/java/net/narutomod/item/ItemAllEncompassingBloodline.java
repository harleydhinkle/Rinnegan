...
public class ItemAllEncompassingBloodline extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:all_encompassing_bloodline")
	...
	public ItemAllEncompassingBloodline(ElementsNarutomodMod instance) {
		super(instance, 731);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemKekkeiMora.RangedItem(EIGHTYGODS, PORTAL, BIGBALL, ASHBONE, PULSE));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:all_encompassing_bloodline", "inventory"));
	}

	public static class RangedItem extends ItemJutsu.Base {
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			super(ItemJutsu.JutsuEnum.Type.KEKKEIMORA, list);
			this.setUnlocalizedName("all_encompassing_bloodline");
			this.setRegistryName("all_encompassing_bloodline");
	...
	public static class ChakraPulse implements ItemJutsu.IJutsuCallback {
		...
		public boolean createJutsu(ItemStack stack, EntityLivingBase entity, float power) {
			entity.world.playSound(null, entity.posX, entity.posY, entity.posZ,
			 net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("narutomod:ocular_jutsu")),
