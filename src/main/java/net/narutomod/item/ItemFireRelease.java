...
public class ItemFireRelease extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:fire_release")
	...
	public static final ItemJutsu.JutsuEnum GFANNIHILATION = new ItemJutsu.JutsuEnum(1, "tooltip.fire_release.annihilation", 'B', 50d, new EntityFirestream.EC.Jutsu1());
	...
	public ItemFireRelease(ElementsNarutomodMod instance) {
		super(instance, 366);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemKaton.RangedItem(GREATFIREBALL, GFANNIHILATION, HIDINGINASH, GREATFLAME, FLAMESLICE, BARRIER));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:fire_release", "inventory"));
	}

	public static class RangedItem extends ItemJutsu.Base {
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			super(ItemJutsu.JutsuEnum.Type.KATON, list);
			this.setRegistryName("fire_release");
			this.setUnlocalizedName("fire_release");
	...
	public static class EntityBigFireball extends EntityScalableProjectile.Base implements ItemJutsu.IJutsu {
		...
		protected void onImpact(RayTraceResult result) {
			...
			if (!this.world.isRemote) {
				...
				this.world.newExplosion(this.shootingEntity, this.posX, this.posY, this.posZ, this.explosionSize, false, true);
				this.setDead();
			}
		}
