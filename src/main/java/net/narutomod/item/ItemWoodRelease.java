...
public class ItemWoodRelease extends ElementsNarutomodMod.ModElement {
    @ObjectHolder("narutomod:wood_release")
    public static final Item block = null;

    public static final ItemJutsu.JutsuEnum WOODBURIAL =
            new ItemJutsu.JutsuEnum(0, "wood_burial", 'S', 100d, new EntityWoodBurial.EC.Jutsu());
    public static final ItemJutsu.JutsuEnum WOODPRISON =
            new ItemJutsu.JutsuEnum(1, "wood_prison", 'S', 50d, new EntityWoodPrison.EC.Jutsu());
    public static final ItemJutsu.JutsuEnum WOODHOUSE =
            new ItemJutsu.JutsuEnum(2, "tooltip.wood_release.rightclick2", 'S', 100d, new JutsuHouse());
    public static final ItemJutsu.JutsuEnum GOLEM =
            new ItemJutsu.JutsuEnum(3, "wood_golem", 'S', 800, 1000d, new EntityWoodGolem.EC.Jutsu());
    public static final ItemJutsu.JutsuEnum ARMATTACK =
            new ItemJutsu.JutsuEnum(4, "wood_arm", 'S', 400, 50d, new EntityWoodArm.EC.Jutsu());
    public static final ItemJutsu.JutsuEnum SPIKE =
            new ItemJutsu.JutsuEnum(5, "wood_cutting", 'S', 400, 50d, new EntityWoodCutting.EC.Jutsu());
    public static final ItemJutsu.JutsuEnum FOREST =
            new ItemJutsu.JutsuEnum(6, "wood_forest", 'S', 800, 20d, new EntityWoodForest.EC.Jutsu());

    public ItemWoodRelease(ElementsNarutomodMod instance) {
        super(instance, 245);
    }

    public void initElements() {
        this.elements.items.add(() -> new ItemMokuton.ItemCustom(WOODBURIAL, WOODPRISON, WOODHOUSE, GOLEM, ARMATTACK, SPIKE, FOREST));
    }

    @SideOnly(Side.CLIENT)
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:wood_release", "inventory"));
    }
    ...
    public static class ItemCustom extends ItemJutsu.Base {
        public ItemCustom(ItemJutsu.JutsuEnum... list) {
            ...
            this.setUnlocalizedName("wood_release");
            this.setRegistryName("wood_release");
            this.setCreativeTab(TabModTab.tab);

            // Cooldowns (20 ticks = 1 second)
            this.defaultCooldownMap[WOODPRISON.index] = 0;
            this.defaultCooldownMap[WOODHOUSE.index]  = 0;
            this.defaultCooldownMap[GOLEM.index]      = 2400;
            this.defaultCooldownMap[WOODBURIAL.index] = 1800;
            // Wood Arm ? 1 minute cooldown (60s * 20t = 1200)
            this.defaultCooldownMap[ARMATTACK.index]  = 1200;
            this.defaultCooldownMap[SPIKE.index]      = 0;
            this.defaultCooldownMap[FOREST.index]     = 2400;
        }
    ...
    public static abstract class WoodSegment extends Entity {
        ...
        public void onUpdate() {
            // ? CRITICAL: keep Entity ticking working (ticksExisted, DataManager, etc.)
            super.onUpdate();

            // ? Optional but recommended: keep segments aligned client-side even before rendering happens
            if (this.world.isRemote) {
    ...
    public static class Renderer extends EntityRendererRegister {
        ...
        public void register() {
            ...
            // Derived entities that reuse the same model/renderer
            RenderingRegistry.registerEntityRenderingHandler(EntityWoodBurial.EC.class, renderManager -> new RenderSegment(renderManager));
            RenderingRegistry.registerEntityRenderingHandler(EntityWoodForest.EC.class, renderManager -> new RenderSegment(renderManager));
            RenderingRegistry.registerEntityRenderingHandler(EntityWoodArm.EC.class, renderManager -> new RenderSegment(renderManager));
        }
