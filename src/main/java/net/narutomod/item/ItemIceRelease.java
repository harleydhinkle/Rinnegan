...
public class ItemIceRelease extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:ice_release")
	...
	public ItemIceRelease(ElementsNarutomodMod instance) {
		super(instance, 531);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemHyoton.RangedItem(KILLSPIKES, ICESPEARS, ICEDOME, ICEPRISON));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:ice_release", "inventory"));
	}
	...
	public static class RangedItem extends ItemJutsu.Base {
		...
		public void onUpdate(ItemStack itemstack, World world, Entity entity, int par4, boolean par5) {
			...
			if (!world.isRemote && entity instanceof EntityLivingBase) {
				...
				living.extinguish();
				// Frost Walker effect removed - no more freezing water to ice.
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add(TextFormatting.GREEN + net.minecraft.util.text.translation.I18n.translateToLocal("tooltip.ice_release.musthave") + TextFormatting.RESET);
		}
			...
			public boolean createJutsu(ItemStack stack, EntityLivingBase entity, float power) {
				...
				if (res != null && res.typeOfHit == RayTraceResult.Type.BLOCK && res.sideHit == EnumFacing.UP) {
					...
					for (int i = 0; i < Math.round(power); i++) {
						...
						for (; !world.getBlockState(new net.minecraft.util.math.BlockPos(vec)).isTopSolid(); vec = vec.subtract(0d, 1d, 0d));
						for (; world.getBlockState(new net.minecraft.util.math.BlockPos(vec).up()).isTopSolid(); vec = vec.addVector(0d, 1d, 0d));
