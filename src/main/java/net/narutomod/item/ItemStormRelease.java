...
public class ItemStormRelease extends ElementsNarutomodMod.ModElement {
	@GameRegistry.ObjectHolder("narutomod:storm_release")
	...
	public ItemStormRelease(ElementsNarutomodMod instance) {
		super(instance, 597);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemRanton.RangedItem(CLOUD, LASERCIRCUS));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("narutomod:storm_release", "inventory"));
	}

	public static class RangedItem extends ItemJutsu.Base {
		public RangedItem(ItemJutsu.JutsuEnum... list) {
			super(ItemJutsu.JutsuEnum.Type.RANTON, list);
			this.setUnlocalizedName("storm_release");
			this.setRegistryName("storm_release");
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			if (entity.isCreative() || (ProcedureUtils.hasItemInInventory(entity, ItemLightningRelease.block) 
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add(TextFormatting.GREEN + net.minecraft.util.text.translation.I18n.translateToLocal("tooltip.storm_release.musthave") + TextFormatting.RESET);
		}
	}
	...
	public static class EntityRaiunkuha extends Entity implements ItemJutsu.IJutsu {
		...
		private float getDamage() {
			return this.rand.nextFloat() * this.damageMultiplier * 15f;
		}
