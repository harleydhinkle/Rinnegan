...
public class GuiScrollWindBladeGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 69;

	public GuiScrollWindBladeGui(ElementsNarutomodMod instance) {
		super(instance, 886);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemWindRelease.RangedItem)ItemWindRelease.block, ItemWindRelease.WINDBLADE, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemWindRelease.WINDBLADE.getName(), 38, 13, -16777216);
		}
	}
}
