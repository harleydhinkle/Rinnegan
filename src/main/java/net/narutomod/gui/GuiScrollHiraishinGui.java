...
public class GuiScrollHiraishinGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 64;

	public GuiScrollHiraishinGui(ElementsNarutomodMod instance) {
		super(instance, 842);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemNinjaArts.RangedItem)ItemNinjaArts.block, ItemNinjaArts.HIRAISHIN, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("narutomod:textures/dui_li_.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 96, this.guiTop + 114, 0, 0, 44, 44, 44, 44);
		}

		@Override
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemNinjaArts.HIRAISHIN.getName(), 38, 13, -16777216);
		}
	}
}
