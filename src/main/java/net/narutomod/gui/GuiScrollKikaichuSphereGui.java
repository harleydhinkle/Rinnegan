...
public class GuiScrollKikaichuSphereGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 55;

	public GuiScrollKikaichuSphereGui(ElementsNarutomodMod instance) {
		super(instance, 750);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemNinjaArts.RangedItem)ItemNinjaArts.block, ItemNinjaArts.BUGSWARM, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 156, this.guiTop + 108, 0, 0, 48, 48, 48, 48);
		}

		@Override
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemNinjaArts.BUGSWARM.getName(), 38, 13, -16777216);
		}
	}
}
