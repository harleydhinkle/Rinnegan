...
public class GuiScrollMindTransferGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 51;

	public GuiScrollMindTransferGui(ElementsNarutomodMod instance) {
		super(instance, 671);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemYinRelease.RangedItem)ItemYinRelease.block, ItemYinRelease.MBTRANSFER, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("narutomod:textures/mindswitchseal.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 90, this.guiTop + 112, 0, 0, 48, 48, 48, 48);
		}

		@Override
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemYinRelease.MBTRANSFER.getName(), 38, 13, -16777216);
		}
	}
}
