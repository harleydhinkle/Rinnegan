...
public class GuiScrollHidingInAshGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 33;

	public GuiScrollHidingInAshGui(ElementsNarutomodMod instance) {
		super(instance, 500);
	}
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 50, this.guiTop + 108, 0, 0, 42, 42, 42, 42);
			this.mc.renderEngine.bindTexture(new ResourceLocation("narutomod:textures/si_.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 100, this.guiTop + 108, 0, 0, 42, 42, 42, 42);
			this.mc.renderEngine.bindTexture(new ResourceLocation("narutomod:textures/yin_.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 150, this.guiTop + 108, 0, 0, 42, 42, 42, 42);
		}
