    ...
    public static class GuiWindow extends GuiContainer {
        ...
        public void updateScreen() {
            ...
            if (helditem.getItem() == ItemTeamScroll.block) {
                ...
                // ========================================
                // EDITED: Join enabled if < MAX_TEAM_SIZE (5) instead of < 3
                // ========================================
                this.joinButton.enabled = names.size() < ItemTeamScroll.MAX_TEAM_SIZE && !names.contains(this.entity.getName());
        ...
        protected void drawGuiContainerForegroundLayer(int par1, int par2) {
            ...
            if (helditem.getItem() == ItemTeamScroll.block) {
                ...
                // ========================================
                // EDITED: Show member count
                // ========================================
                Collection<String> members = ItemTeamScroll.ItemCustom.getTeamMembers(this.world, helditem);
                this.fontRenderer.drawString(
                        members.size() + "/" + ItemTeamScroll.MAX_TEAM_SIZE + " members",
                        61, 46, 0xFF999999);

                // ========================================
                // EDITED: Display up to 5 members instead of 3
                // ========================================
                int i = 0;
                int j = 60;
                int lineSpacing = members.size() > 3 ? 12 : 16;

                for (String name : members) {
                    if (i >= ItemTeamScroll.MAX_TEAM_SIZE) {
                        break;
                    }
