...
public class GuiScrollWaterShockwaveGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 39;

	public GuiScrollWaterShockwaveGui(ElementsNarutomodMod instance) {
		super(instance, 511);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemWaterRelease.RangedItem)ItemWaterRelease.block, ItemWaterRelease.WATERSHOCK, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("narutomod:textures/blocks/water_release.png"));
			...
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 0, this.guiTop + 116, 0, 0, 42, 42, 42, 42);
			this.mc.renderEngine.bindTexture(new ResourceLocation("narutomod:textures/wei_.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 50, this.guiTop + 116, 0, 0, 42, 42, 42, 42);
		}

		@Override
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemWaterRelease.WATERSHOCK.getName(), 38, 13, -16777216);
		}
	}
}
