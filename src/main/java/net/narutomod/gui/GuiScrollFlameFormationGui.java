...
public class GuiScrollFlameFormationGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 68;

	public GuiScrollFlameFormationGui(ElementsNarutomodMod instance) {
		super(instance, 880);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemFireRelease.RangedItem)ItemFireRelease.block, ItemFireRelease.BARRIER, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemFireRelease.BARRIER.getName(), 38, 13, -16777216);
		}
	}
}
