...
public class GuiScrollPoisonMistGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 42;

	public GuiScrollPoisonMistGui(ElementsNarutomodMod instance) {
		super(instance, 561);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (stack != null && PlayerTracker.isNinja(player)) {
				((ItemMedicalNinjutsu.RangedItem)stack.getItem()).enableJutsu(stack, ItemMedicalNinjutsu.POISONMIST, true);
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemMedicalNinjutsu.POISONMIST.getName(), 38, 13, -16777216);
		}
	}
}
