...
public class GuiScrollMultiSizeGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 45;

	public GuiScrollMultiSizeGui(ElementsNarutomodMod instance) {
		super(instance, 566);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemYangRelease.RangedItem)ItemYangRelease.block, ItemYangRelease.MULTISIZE, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.mc.renderEngine.bindTexture(new ResourceLocation("narutomod:textures/blocks/yang_release.png"));
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemYangRelease.MULTISIZE.getName(), 38, 13, -16777216);
		}
	}
}
