...
public class GuiScrollEnhancedStrengthGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 44;

	public GuiScrollEnhancedStrengthGui(ElementsNarutomodMod instance) {
		super(instance, 564);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (stack != null && PlayerTracker.isNinja(player)) {
				((ItemMedicalNinjutsu.RangedItem)stack.getItem()).enableJutsu(stack, ItemMedicalNinjutsu.POWERMODE, true);
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemMedicalNinjutsu.POWERMODE.getName(), 38, 13, -16777216);
		}
	}
}
