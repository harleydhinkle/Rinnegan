...
public class GuiScrollShikigamiGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 72;

	public GuiScrollShikigamiGui(ElementsNarutomodMod instance) {
		super(instance, 913);
	}
