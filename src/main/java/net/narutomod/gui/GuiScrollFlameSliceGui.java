...
public class GuiScrollFlameSliceGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 66;

	public GuiScrollFlameSliceGui(ElementsNarutomodMod instance) {
		super(instance, 878);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemFireRelease.RangedItem)ItemFireRelease.block, ItemFireRelease.FLAMESLICE, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemFireRelease.FLAMESLICE.getName(), 38, 13, -16777216);
		}
	}
}
