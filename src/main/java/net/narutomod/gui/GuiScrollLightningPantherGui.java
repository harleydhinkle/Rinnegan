...
public class GuiScrollLightningPantherGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 59;

	public GuiScrollLightningPantherGui(ElementsNarutomodMod instance) {
		super(instance, 802);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemLightningRelease.RangedItem)ItemLightningRelease.block, ItemLightningRelease.BLACKPANTHER, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(I18n.translateToLocal(ItemLightningRelease.block.getUnlocalizedName()+".name")+": "+ItemLightningRelease.BLACKPANTHER.getName(), 38, 13, -16777216);
		}
	}
}
