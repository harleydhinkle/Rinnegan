...
public class GuiScrollHidingInCamouflageGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 54;

	public GuiScrollHidingInCamouflageGui(ElementsNarutomodMod instance) {
		super(instance, 732);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemNinjaArts.RangedItem)ItemNinjaArts.block, ItemNinjaArts.INVISABILITY, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemNinjaArts.INVISABILITY.getName(), 38, 13, -16777216);
		}
	}
}
