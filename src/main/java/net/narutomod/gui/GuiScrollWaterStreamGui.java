...
public class GuiScrollWaterStreamGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 35;

	public GuiScrollWaterStreamGui(ElementsNarutomodMod instance) {
		super(instance, 503);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemWaterRelease.RangedItem)ItemWaterRelease.block, ItemWaterRelease.WATERBULLET, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 150, this.guiTop + 110, 0, 0, 42, 42, 42, 42);
		}

		@Override
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemWaterRelease.WATERBULLET.getName(), 38, 13, -16777216);
		}
	}
}
