...
public class GuiScrollShadowImitationGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 50;

	public GuiScrollShadowImitationGui(ElementsNarutomodMod instance) {
		super(instance, 669);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			if (player.world.isRemote || !player.world.isBlockLoaded(new BlockPos(this.x, this.y, this.z)))
				return;
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemYinRelease.RangedItem)ItemYinRelease.block, ItemYinRelease.SHADOW_IMITATION, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemYinRelease.SHADOW_IMITATION.getName(), 38, 13, -16777216);
		}
	}
}
