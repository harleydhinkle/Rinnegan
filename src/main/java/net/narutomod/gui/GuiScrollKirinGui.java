...
public class GuiScrollKirinGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 61;

	public GuiScrollKirinGui(ElementsNarutomodMod instance) {
		super(instance, 821);
	}
