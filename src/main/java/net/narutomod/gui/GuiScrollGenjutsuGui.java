...
public class GuiScrollGenjutsuGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 27;

	public GuiScrollGenjutsuGui(ElementsNarutomodMod instance) {
		super(instance, 488);
	}
