...
public class GuiScrollEarthDragonGui extends ElementsNarutomodMod.ModElement {
	public static int GUIID = 74;

	public GuiScrollEarthDragonGui(ElementsNarutomodMod instance) {
		super(instance, 944);
	}
	...
	public static class GuiContainerMod extends GuiNinjaScroll.GuiContainerMod {
		...
		protected void handleButtonAction(EntityPlayer player, int buttonID) {
			...
			ItemStack stack = GuiNinjaScroll.enableJutsu(player, (ItemEarthRelease.RangedItem)ItemEarthRelease.block, ItemEarthRelease.DRAGON, true);
			if (stack != null) {
	...
	public static class GuiWindow extends GuiNinjaScroll.GuiWindow {
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 48, this.guiTop + 108, 0, 0, 48, 48, 48, 48);
			this.mc.renderEngine.bindTexture(new ResourceLocation("narutomod:textures/chen_.png"));
			this.drawModalRectWithCustomSizedTexture(this.guiLeft + 96, this.guiTop + 108, 0, 0, 48, 48, 48, 48);
		}

		@Override
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString(ItemEarthRelease.DRAGON.getName(), 38, 13, -16777216);
		}
	}
}
