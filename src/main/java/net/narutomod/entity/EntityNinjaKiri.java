...
public class EntityNinjaKiri extends ElementsNarutomodMod.ModElement {
    public static final int ENTITYID = 307;
    public static final int ENTITYID_RANGED = 308;

    public EntityNinjaKiri(ElementsNarutomodMod instance) {
        super(instance, 626);
    }
    ...
    public void initElements() {
        elements.entities.add(() -> EntityEntryBuilder.create()
                ...
                .id(new ResourceLocation("narutomod", "ninja_kiri"), ENTITYID)
                .name("ninja_kiri")
                .tracker(64, 3, true)
                .egg(-16777216, -10066330)
                .build());
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        EntityNinjaKiriClient.register();
    }
...
@SideOnly(Side.CLIENT)
class EntityNinjaKiriClient {
    static void register() {
        net.minecraftforge.fml.client.registry.RenderingRegistry.registerEntityRenderingHandler(
                EntityNinjaKiri.EntityCustom.class,
                manager -> new net.minecraft.client.renderer.entity.RenderLiving<EntityNinjaKiri.EntityCustom>(
                        manager,
                        new ModelNinjaKiriBiped64(),
                        0.5F
                ) {
                    @Override
                    protected net.minecraft.util.ResourceLocation getEntityTexture(EntityNinjaKiri.EntityCustom entity) {
                        return new net.minecraft.util.ResourceLocation("narutomod:textures/ninja_kiri.png");
                    }
                }
        );
    }
...
@SideOnly(Side.CLIENT)
class ModelNinjaKiriBiped64 extends net.minecraft.client.model.ModelBiped {
    public ModelNinjaKiriBiped64() {
