...
public class EntityNinjaSuna extends ElementsNarutomodMod.ModElement {
    public static final int ENTITYID = 313;
    public static final int ENTITYID_RANGED = 314;

    public EntityNinjaSuna(ElementsNarutomodMod instance) {
        super(instance, 629);
    }
    ...
    public void initElements() {
        elements.entities.add(() -> EntityEntryBuilder.create()
                ...
                .id(new ResourceLocation("narutomod", "ninja_suna"), ENTITYID)
                .name("ninja_suna")
                .tracker(64, 3, true)
                .egg(-7044282, -16777216)
                .build());
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        EntityNinjaSunaClient.register();
    }
...
@SideOnly(Side.CLIENT)
class EntityNinjaSunaClient {
    static void register() {
        net.minecraftforge.fml.client.registry.RenderingRegistry.registerEntityRenderingHandler(
                EntityNinjaSuna.EntityCustom.class,
                manager -> new net.minecraft.client.renderer.entity.RenderLiving<EntityNinjaSuna.EntityCustom>(
                        manager,
                        new ModelNinjaSunaBiped64(),
                        0.5F
                ) {
                    @Override
                    protected net.minecraft.util.ResourceLocation getEntityTexture(EntityNinjaSuna.EntityCustom entity) {
                        return new net.minecraft.util.ResourceLocation("narutomod:textures/ninja_suna.png");
                    }
                }
        );
    }
...
@SideOnly(Side.CLIENT)
class ModelNinjaSunaBiped64 extends net.minecraft.client.model.ModelBiped {
    public ModelNinjaSunaBiped64() {
