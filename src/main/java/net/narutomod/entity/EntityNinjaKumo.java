...
public class EntityNinjaKumo extends ElementsNarutomodMod.ModElement {
    public static final int ENTITYID = 311;
    public static final int ENTITYID_RANGED = 312;

    public EntityNinjaKumo(ElementsNarutomodMod instance) {
        super(instance, 628);
    }
    ...
    public void initElements() {
        elements.entities.add(() -> EntityEntryBuilder.create()
                ...
                .id(new ResourceLocation("narutomod", "ninja_kumo"), ENTITYID)
                .name("ninja_kumo")
                .tracker(64, 3, true)
                .egg(-6395566, -1)
                .build());
    ...
    /**
     * SpongeForge-safe pattern (Temari style):
    ...
    public void preInit(FMLPreInitializationEvent event) {
        EntityNinjaKumoClient.register();
    }
...
@SideOnly(Side.CLIENT)
class EntityNinjaKumoClient {
    static void register() {
        net.minecraftforge.fml.client.registry.RenderingRegistry.registerEntityRenderingHandler(
                EntityNinjaKumo.EntityCustom.class,
                manager -> new net.minecraft.client.renderer.entity.RenderLiving<EntityNinjaKumo.EntityCustom>(
                        manager,
                        new ModelNinjaKumoBiped64(),
                        0.5F
                ) {
                    @Override
                    protected net.minecraft.util.ResourceLocation getEntityTexture(EntityNinjaKumo.EntityCustom entity) {
                        return new net.minecraft.util.ResourceLocation("narutomod:textures/ninja_kumo.png");
                    }
                }
        );
    }
...
@SideOnly(Side.CLIENT)
class ModelNinjaKumoBiped64 extends net.minecraft.client.model.ModelBiped {
    public ModelNinjaKumoBiped64() {
