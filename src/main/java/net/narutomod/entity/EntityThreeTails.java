...
public class EntityThreeTails extends ElementsNarutomodMod.ModElement {
	...
	public static class EntityCustom extends EntityTailedBeast.Base {
		...
		protected void applyEntityAttributes() {
			...
			this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(700000.0D);
		...
		public void updatePassenger(Entity passenger) {
			Vec3d vec[] = { new Vec3d(0d, 0d, 0.25d * MODELSCALE) };
		...
		public void attackEntityWithRangedAttack(EntityLivingBase target, float distanceFactor) {
			if (!this.isAIDisabled() && (this.mouthShootingJutsu == null || this.mouthShootingJutsu.isDead)
			 && distanceFactor < 1.0f && distanceFactor > (float)(ProcedureUtils.getReachDistance(this) * 0.6d / this.getBijudamaMinRange())) {
				...
				this.mouthShootingJutsu = EntityWaterCanonball.EC.Jutsu.createJutsu(this, 10.0f);
			} else {
		...
		public void onUpdate() {
			super.onUpdate();
			boolean inwater = this.isInsideOfMaterial(Material.WATER);
			if (inwater && this.moveHelper != this.altMoveHelper) {
				this.moveHelper = this.altMoveHelper;
			} else if (!inwater && this.moveHelper != this.mainMoveHelper) {
		...
		public float getBlockPathWeight(BlockPos pos) {
			...
			return biome == Biomes.DEEP_OCEAN ? 50.0F : biome == Biomes.OCEAN ? 40.0F
			 : this.world.getBlockState(pos).getMaterial() == Material.WATER ? 30.0F
			 : biome == Biomes.BEACH || biome == Biomes.STONE_BEACH ? 20.0F
			 : 0.0F;
		}
	...
	public static class Renderer extends EntityRendererRegister {
		...
		public class ModelThreeTails extends ModelBiped {
			...
			private final ModelRenderer bone84_r2;
			...
			private final ModelRenderer[][] tail = new ModelRenderer[3][9];
			private final float tailSwayX[][] = new float[3][9];
			private final float tailSwayY[][] = new float[3][9];
			private final float tailSwayZ[][] = new float[3][9];
			...
			public ModelThreeTails() {
				...
				bipedHeadwear.setRotationPoint(0.0F, 21.0F, 9.5F);
				
		
				eye = new ModelRenderer(this);
				eye.setRotationPoint(0.0F, -5.0F, -11.5F);
				bipedHeadwear.addChild(eye);
				eye.cubeList.add(new ModelBox(eye, 17, 52, 0.6F, -1.2F, -5.0F, 1, 1, 1, 0.1F, false));
		
				bipedBody = new ModelRenderer(this);
				bipedBody.setRotationPoint(0.0F, 21.0F, 9.5F);
				
		
				bipedHead = new ModelRenderer(this);
				bipedHead.setRotationPoint(0.0F, -5.0F, -11.5F);
				...
				torso.setRotationPoint(0.0F, -5.0F, -9.5F);
				bipedBody.addChild(torso);
				setRotationAngle(torso, -0.5236F, 0.0F, 0.0F);
				torso.cubeList.add(new ModelBox(torso, 0, 0, -3.5F, -2.7F, -3.0F, 7, 5, 7, 0.0F, false));
				torso.cubeList.add(new ModelBox(torso, 0, 12, -3.5F, 1.2593F, -2.9789F, 7, 3, 7, 0.0F, false));
				...
				cube_r20.setRotationPoint(0.0F, 2.35F, 10.75F);
				torso.addChild(cube_r20);
				setRotationAngle(cube_r20, 1.309F, 0.0F, 0.0F);
				cube_r20.cubeList.add(new ModelBox(cube_r20, 22, 32, -3.0F, -2.0F, 0.0F, 6, 2, 2, 0.0F, false));
		
				bone85_r1 = new ModelRenderer(this);
				bone85_r1.setRotationPoint(-5.5F, 0.0F, 4.05F);
				torso.addChild(bone85_r1);
				setRotationAngle(bone85_r1, 0.0F, 0.3927F, 0.0F);
				bone85_r1.cubeList.add(new ModelBox(bone85_r1, 23, 22, 0.0F, -2.0F, 0.25F, 2, 4, 5, 0.0F, false));
		
				bone84_r1 = new ModelRenderer(this);
				bone84_r1.setRotationPoint(5.5F, 0.0F, 4.05F);
				torso.addChild(bone84_r1);
				setRotationAngle(bone84_r1, 0.0F, -0.3927F, 0.0F);
				bone84_r1.cubeList.add(new ModelBox(bone84_r1, 23, 22, -2.0F, -2.0F, 0.25F, 2, 4, 5, 0.0F, true));
		
				bone84_r2 = new ModelRenderer(this);
				bone84_r2.setRotationPoint(0.0F, 4.2593F, 4.0211F);
				torso.addChild(bone84_r2);
				setRotationAngle(bone84_r2, 0.2618F, 0.0F, 0.0F);
				bone84_r2.cubeList.add(new ModelBox(bone84_r2, 0, 12, -3.5F, -3.0F, 0.0F, 7, 3, 7, 0.0F, false));
				...
				shell.setRotationPoint(-0.1F, -7.25F, -7.0F);
				...
				cube_r9.setRotationPoint(-4.4F, 0.15F, 4.0F);
				shell.addChild(cube_r9);
				setRotationAngle(cube_r9, -0.2618F, 0.0F, -0.6981F);
				cube_r9.cubeList.add(new ModelBox(cube_r9, 41, 12, -3.5F, 0.1553F, -0.1739F, 4, 1, 2, 0.0F, false));
				cube_r9.cubeList.add(new ModelBox(cube_r9, 0, 44, -2.75F, 0.1553F, 1.8261F, 3, 1, 2, 0.0F, false));
				cube_r9.cubeList.add(new ModelBox(cube_r9, 1, 44, -2.0F, 0.1553F, 3.8261F, 2, 1, 2, 0.0F, false));
		
				cube_r10 = new ModelRenderer(this);
				cube_r10.setRotationPoint(4.6F, 0.15F, 4.0F);
				shell.addChild(cube_r10);
				setRotationAngle(cube_r10, -0.2618F, 0.0F, 0.6981F);
				cube_r10.cubeList.add(new ModelBox(cube_r10, 41, 12, -0.5F, 0.1553F, -0.1739F, 4, 1, 2, 0.0F, true));
				cube_r10.cubeList.add(new ModelBox(cube_r10, 0, 44, -0.25F, 0.1553F, 1.8261F, 3, 1, 2, 0.0F, true));
				cube_r10.cubeList.add(new ModelBox(cube_r10, 1, 44, 0.0F, 0.1553F, 3.8261F, 2, 1, 2, 0.0F, true));
		
				cube_r11 = new ModelRenderer(this);
				cube_r11.setRotationPoint(-3.9F, -0.5F, 2.0F);
				shell.addChild(cube_r11);
				setRotationAngle(cube_r11, -0.1745F, 0.0F, -0.6109F);
				cube_r11.cubeList.add(new ModelBox(cube_r11, 32, 23, -5.0F, 0.0F, 0.0F, 5, 1, 2, 0.0F, false));
		
				cube_r8 = new ModelRenderer(this);
				cube_r8.setRotationPoint(4.1F, -0.5F, 2.0F);
				shell.addChild(cube_r8);
				setRotationAngle(cube_r8, -0.1745F, 0.0F, 0.6109F);
				cube_r8.cubeList.add(new ModelBox(cube_r8, 32, 23, 0.0F, 0.0F, 0.0F, 5, 1, 2, 0.0F, true));
				...
				spike34.setRotationPoint(-3.4F, 0.55F, 5.75F);
				shell.addChild(spike34);
				setRotationAngle(spike34, -1.6955F, -1.2662F, 1.4138F);
				spike34.cubeList.add(new ModelBox(spike34, 0, 23, -0.5F, -1.0F, -0.5F, 1, 1, 1, -0.1F, false));
		
				bone83 = new ModelRenderer(this);
				bone83.setRotationPoint(0.0F, -0.5F, 0.0F);
				spike34.addChild(bone83);
				setRotationAngle(bone83, -0.0873F, 0.0F, 0.0873F);
				bone83.cubeList.add(new ModelBox(bone83, 0, 23, -0.5F, -1.0F, -0.5F, 1, 1, 1, -0.2F, false));
		
				bone149 = new ModelRenderer(this);
				bone149.setRotationPoint(0.0F, -0.5F, 0.0F);
				bone83.addChild(bone149);
				setRotationAngle(bone149, -0.0873F, 0.0F, 0.0873F);
				bone149.cubeList.add(new ModelBox(bone149, 0, 23, -0.5F, -1.0F, -0.5F, 1, 1, 1, -0.3F, false));
		
				bone150 = new ModelRenderer(this);
				bone150.setRotationPoint(0.0F, -0.25F, 0.0F);
				bone149.addChild(bone150);
				setRotationAngle(bone150, -0.0873F, 0.0F, 0.0873F);
				bone150.cubeList.add(new ModelBox(bone150, 0, 23, -0.5F, -1.0F, -0.5F, 1, 1, 1, -0.4F, false));
		
				spike35 = new ModelRenderer(this);
				spike35.setRotationPoint(0.0F, -0.3F, 0.0F);
				spike34.addChild(spike35);
				setRotationAngle(spike35, 0.0F, -2.5307F, 0.1745F);
				spike35.cubeList.add(new ModelBox(spike35, 0, 23, -3.0673F, -0.2679F, 0.4344F, 1, 1, 1, -0.1F, false));
		
				bone151 = new ModelRenderer(this);
				bone151.setRotationPoint(0.0F, -0.5F, 0.0F);
				spike35.addChild(bone151);
				setRotationAngle(bone151, -0.0873F, 0.0F, 0.0873F);
				bone151.cubeList.add(new ModelBox(bone151, 0, 23, -2.9937F, -0.132F, 0.5139F, 1, 1, 1, -0.2F, false));
		
				bone152 = new ModelRenderer(this);
				bone152.setRotationPoint(0.0F, -0.5F, 0.0F);
				bone151.addChild(bone152);
				setRotationAngle(bone152, -0.0873F, 0.0F, 0.0873F);
				bone152.cubeList.add(new ModelBox(bone152, 0, 23, -2.9086F, -0.0105F, 0.6044F, 1, 1, 1, -0.3F, false));
		
				bone153 = new ModelRenderer(this);
				bone153.setRotationPoint(0.0F, -0.25F, 0.0F);
				bone152.addChild(bone153);
				setRotationAngle(bone153, -0.0873F, 0.0F, 0.0873F);
				...
				bone154.setRotationPoint(0.0F, -0.5F, 0.0F);
				spike36.addChild(bone154);
				setRotationAngle(bone154, -0.0873F, 0.0F, 0.0873F);
				bone154.cubeList.add(new ModelBox(bone154, 0, 23, -2.9937F, -0.132F, 0.5139F, 1, 1, 1, -0.2F, false));
		
				bone155 = new ModelRenderer(this);
				bone155.setRotationPoint(0.0F, -0.5F, 0.0F);
				bone154.addChild(bone155);
				setRotationAngle(bone155, -0.0873F, 0.0F, 0.0873F);
				bone155.cubeList.add(new ModelBox(bone155, 0, 23, -2.9086F, -0.0105F, 0.6044F, 1, 1, 1, -0.3F, false));
		
				bone156 = new ModelRenderer(this);
				bone156.setRotationPoint(0.0F, -0.25F, 0.0F);
				bone155.addChild(bone156);
				setRotationAngle(bone156, -0.0873F, 0.0F, 0.0873F);
				bone156.cubeList.add(new ModelBox(bone156, 0, 23, -2.8132F, 0.0949F, 0.7044F, 1, 1, 1, -0.4F, false));
		
				spike37 = new ModelRenderer(this);
				spike37.setRotationPoint(3.6F, 0.55F, 5.75F);
				shell.addChild(spike37);
				setRotationAngle(spike37, -1.6955F, 1.2662F, -1.4138F);
				spike37.cubeList.add(new ModelBox(spike37, 0, 23, -0.5F, -1.0F, -0.5F, 1, 1, 1, -0.1F, true));
		
				bone157 = new ModelRenderer(this);
				bone157.setRotationPoint(0.0F, -0.5F, 0.0F);
				spike37.addChild(bone157);
				setRotationAngle(bone157, -0.0873F, 0.0F, -0.0873F);
				bone157.cubeList.add(new ModelBox(bone157, 0, 23, -0.5F, -1.0F, -0.5F, 1, 1, 1, -0.2F, true));
		
				bone158 = new ModelRenderer(this);
				bone158.setRotationPoint(0.0F, -0.5F, 0.0F);
				bone157.addChild(bone158);
				setRotationAngle(bone158, -0.0873F, 0.0F, -0.0873F);
				bone158.cubeList.add(new ModelBox(bone158, 0, 23, -0.5F, -1.0F, -0.5F, 1, 1, 1, -0.3F, true));
		
				bone159 = new ModelRenderer(this);
				bone159.setRotationPoint(0.0F, -0.25F, 0.0F);
				bone158.addChild(bone159);
				setRotationAngle(bone159, -0.0873F, 0.0F, -0.0873F);
				bone159.cubeList.add(new ModelBox(bone159, 0, 23, -0.5F, -1.0F, -0.5F, 1, 1, 1, -0.4F, true));
		
				spike38 = new ModelRenderer(this);
				spike38.setRotationPoint(0.0F, -0.3F, 0.0F);
				spike37.addChild(spike38);
				setRotationAngle(spike38, 0.0F, 2.5307F, -0.1745F);
				spike38.cubeList.add(new ModelBox(spike38, 0, 23, 2.0673F, -0.2679F, 0.4344F, 1, 1, 1, -0.1F, true));
		
				bone160 = new ModelRenderer(this);
				bone160.setRotationPoint(0.0F, -0.5F, 0.0F);
				spike38.addChild(bone160);
				setRotationAngle(bone160, -0.0873F, 0.0F, -0.0873F);
				bone160.cubeList.add(new ModelBox(bone160, 0, 23, 1.9937F, -0.132F, 0.5139F, 1, 1, 1, -0.2F, true));
		
				bone161 = new ModelRenderer(this);
				bone161.setRotationPoint(0.0F, -0.5F, 0.0F);
				bone160.addChild(bone161);
				setRotationAngle(bone161, -0.0873F, 0.0F, -0.0873F);
				bone161.cubeList.add(new ModelBox(bone161, 0, 23, 1.9086F, -0.0105F, 0.6044F, 1, 1, 1, -0.3F, true));
		
				bone162 = new ModelRenderer(this);
				bone162.setRotationPoint(0.0F, -0.25F, 0.0F);
				bone161.addChild(bone162);
				setRotationAngle(bone162, -0.0873F, 0.0F, -0.0873F);
				...
				bone163.setRotationPoint(0.0F, -0.5F, 0.0F);
				spike39.addChild(bone163);
				setRotationAngle(bone163, -0.0873F, 0.0F, -0.0873F);
				bone163.cubeList.add(new ModelBox(bone163, 0, 23, 1.9937F, -0.132F, 0.5139F, 1, 1, 1, -0.2F, true));
		
				bone164 = new ModelRenderer(this);
				bone164.setRotationPoint(0.0F, -0.5F, 0.0F);
				bone163.addChild(bone164);
				setRotationAngle(bone164, -0.0873F, 0.0F, -0.0873F);
				bone164.cubeList.add(new ModelBox(bone164, 0, 23, 1.9086F, -0.0105F, 0.6044F, 1, 1, 1, -0.3F, true));
		
				bone165 = new ModelRenderer(this);
				bone165.setRotationPoint(0.0F, -0.25F, 0.0F);
				bone164.addChild(bone165);
				setRotationAngle(bone165, -0.0873F, 0.0F, -0.0873F);
				bone165.cubeList.add(new ModelBox(bone165, 0, 23, 1.8132F, 0.0949F, 0.7044F, 1, 1, 1, -0.4F, true));
				...
				bipedRightArm.setRotationPoint(-5.5F, -5.0F, -10.0F);
				...
				spike20.setRotationPoint(-3.5F, 1.05F, -1.25F);
				...
				bipedLeftArm.setRotationPoint(5.5F, -5.0F, -10.0F);
				...
				spike21.setRotationPoint(3.5F, 1.05F, -1.25F);
				...
				tails.setRotationPoint(0.0F, 21.0F, 9.5F);
				...
				tail[0][7].cubeList.add(new ModelBox(tail[0][7], 43, 0, -2.0F, -4.0F, -0.5F, 4, 4, 1, 0.025F, false));
				...
				tail[0][8].cubeList.add(new ModelBox(tail[0][8], 54, 59, -2.0F, -4.0F, -0.5F, 4, 4, 1, 0.0F, false));
				...
				tail[1][7].cubeList.add(new ModelBox(tail[1][7], 43, 0, -2.0F, -4.0F, -0.5F, 4, 4, 1, 0.025F, false));
				...
				tail[1][8].cubeList.add(new ModelBox(tail[1][8], 54, 59, -2.0F, -4.0F, -0.5F, 4, 4, 1, 0.0F, false));
				...
				tail[2][7].cubeList.add(new ModelBox(tail[2][7], 43, 0, -2.0F, -4.0F, -0.5F, 4, 4, 1, 0.025F, true));
				...
				tail[2][8].cubeList.add(new ModelBox(tail[2][8], 54, 59, -2.0F, -4.0F, -0.5F, 4, 4, 1, 0.0F, true));

				for (int i = 0; i < tail.length; i++) {
					for (int j = 1; j < tail[i].length; j++) {
			...
			public void setRotationAngles(float f0, float f1, float f2, float f3, float f4, float f5, Entity e) {
				...
				if (((EntityCustom) e).isFaceDown()) {
					bipedBody.rotationPointZ = 13.0F;
					...
					tails.rotationPointZ = 13.0F;
					tails.rotateAngleX = -0.8727F;
				} else {
					bipedBody.rotationPointZ = 9.5F;
					bipedBody.rotateAngleX = 0.0F;
					tails.rotationPointZ = 9.5F;
