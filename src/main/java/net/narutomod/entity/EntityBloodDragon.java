...
public class EntityBloodDragon extends ElementsNarutomodMod.ModElement {
	public static final int ENTITYID = 466;
	public static final int ENTITYID_RANGED = 467;

	public EntityBloodDragon(ElementsNarutomodMod instance) {
		super(instance, 728);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EC.class)
		 .id(new ResourceLocation("narutomod", "blood_dragon"), ENTITYID).name("blood_dragon").tracker(64, 3, true).build());
	}
...
//System.out.println(s+", partRot:"+this.partRot);
		...
		public void renderParticles() {
			if (this.world instanceof WorldServer) {
				if (this.isLaunched()) {
					((WorldServer)this.world).spawnParticle(EnumParticleTypes.REDSTONE, this.posX,
					...
					((WorldServer)this.world).spawnParticle(EnumParticleTypes.REDSTONE, vec.x, vec.y, vec.z,
  this.ticksAlive * 5, this.width/2, this.height/2, this.width/2, 0);
				}
			}
		}
		...
		protected void onImpact(RayTraceResult result) {
			...
			if (!this.world.isRemote) {
				...
				this.world.newExplosion(this.shootingEntity, this.posX, this.posY, this.posZ, 10.0F * size, false,
	...
	public static class Renderer extends EntityRendererRegister {
		...
		public class RenderDragon extends Render<EC> {
			private final ResourceLocation texture = new ResourceLocation("narutomod:textures/dragon_red.png");
			...
			public void doRender(EC entity, double x, double y, double z, float yaw, float pt) {
				...
				GlStateManager.color(0.5F, 0.02F, 0.02F);
