...
import net.narutomod.block.BlockBloodWater;
import net.narutomod.item.ItemBloodRelease;
...
public class EntityBloodPrison extends ElementsNarutomodMod.ModElement {
    public static final int ENTITYID_BLOOD = 158;
    public static final int ENTITYID_BLOOD_RANGED = 159;
    private static final Map<EntityLivingBase, EntityLivingBase> trappedMap = Maps.newHashMap();

    public EntityBloodPrison(ElementsNarutomodMod instance) {
        super(instance, 412);
    }
    ...
    public void initElements() {
        elements.entities.add(() -> EntityEntryBuilder.create().entity(EC.class)
                .id(new ResourceLocation("narutomod", "blood_prison"), ENTITYID_BLOOD)
                .name("blood_prison").tracker(64, 3, true).build());
    }
    ...
    public static boolean isEntityTrappedBy(EntityLivingBase trapper, EntityLivingBase target) {
        ...
        return entity1 != null && entity1.equals(target);
    }
    ...
    public static class EC extends Entity implements ItemJutsu.IJutsu {
        ...
        private AxisAlignedBB realBB; // <-- properly declared here
        private int totalWaterBlocks;
        private int duration;
        private final double chakraBurn = ItemBloodRelease.BLOODPRISON.chakraUsage * 0.1d; // per second
        ...
        public EC(EntityLivingBase userIn, EntityLivingBase targetIn, int durationIn) {
            ...
            for (BlockPos pos : BlockPos.getAllInBoxMutable(minX, minY, minZ, maxX, maxY, maxZ)) {
                ...
                if (blockstate.getMaterial() == Material.AIR
                    ...
                    this.world.setBlockState(pos, BlockBloodWater.block.getDefaultState(), 3);
        ...
        public void setDead() {
            ...
            if (!this.world.isRemote) {
                ...
                // Remove all Blood Water blocks
                for (BlockPos pos : BlockPos.getAllInBoxMutable((int)this.realBB.minX, (int)this.realBB.minY,
                        (int)this.realBB.minZ, (int)this.realBB.maxX, (int)this.realBB.maxY, (int)this.realBB.maxZ)) {
                    if (this.world.getBlockState(pos).getBlock() == BlockBloodWater.block) {
        ...
        protected void readEntityFromNBT(NBTTagCompound compound) {
            ...
            this.realBB = new AxisAlignedBB(compound.getDouble("minX"), compound.getDouble("minY"),
                    compound.getDouble("minZ"), compound.getDouble("maxX"), compound.getDouble("maxY"),
        ...
        public static class Jutsu implements ItemJutsu.IJutsuCallback {
            ...
            public Entity createJutsu(EntityLivingBase entity, EntityLivingBase target, int duration) {
                if (entity.getDistance(target) <= 4.0d && target.width <= 2.0f && target.height <= 3.0f) {
                    ...
                    Entity entitytospawn = new EC(entity, target, duration);
