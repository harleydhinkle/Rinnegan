...
public class EntityKakashi extends ElementsNarutomodMod.ModElement {
    ...
    public void initElements() {
        elements.entities.add(() -> EntityEntryBuilder.create()
                ...
                .id(new ResourceLocation("narutomod", "kakashi"), ENTITYID)
                .name("kakashi")
                .tracker(64, 3, true)
                .egg(-16737946, -16764058)
                .build());
    }
    ...
    /**
     * SpongeForge-safe:
     * Do NOT define any inner client-only Renderer/Model classes in this class.
     * Just call a client-only top-level helper (same file, see bottom).
     */
    @SideOnly(Side.CLIENT)
    @Override
    public void preInit(FMLPreInitializationEvent event) {
        EntityKakashiClient.register();
    }
...
@SideOnly(Side.CLIENT)
class EntityKakashiClient {
    static void register() {
        net.minecraftforge.fml.client.registry.RenderingRegistry.registerEntityRenderingHandler(
                EntityKakashi.EntityCustom.class,
                renderManager -> new net.minecraft.client.renderer.entity.RenderLiving<EntityKakashi.EntityCustom >(
                        renderManager,
                        new ModelKakashiBiped64(),
                        0.5F
                ) {
                    @Override
                    protected net.minecraft.util.ResourceLocation getEntityTexture(EntityKakashi.EntityCustom entity) {
                        return new net.minecraft.util.ResourceLocation("narutomod:textures/kakashi.png");
                    }
                }
        );
    }
...
@SideOnly(Side.CLIENT)
class ModelKakashiBiped64 extends net.minecraft.client.model.ModelBiped {
    public ModelKakashiBiped64() {
