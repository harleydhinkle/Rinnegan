...
public class EntitySwampTar extends ElementsNarutomodMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EC.class)
				.id(new ResourceLocation("narutomod", "swamp_tar"), ENTITYID).name("swamp_tar").tracker(64, 3, true).build());
	}
	...
	public static class EC extends EntityParticle.Base implements ItemJutsu.IJutsu {
		...
		public ItemJutsu.JutsuEnum.Type getJutsuType() {
			return ItemJutsu.JutsuEnum.Type.SWAMP;
		}
