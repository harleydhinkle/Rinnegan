...
public class EntityIceDome extends ElementsNarutomodMod.ModElement {
	...
	public static class EC extends EntityShieldBase implements ItemJutsu.IJutsu {
		...
		// =========================
		// UPDATED: 1 MIN COOLDOWN + MESSAGE
		// =========================
		public static class Jutsu implements ItemJutsu.IJutsuCallback {
			private static final String NBT_KEY = "narutomod_icedome_cd_until";
			private static final int COOLDOWN_TICKS = 1200; // 1 minute (20 tps)
			...
			private static void tellCooldown(EntityPlayer p, int leftTicks) {
				...
				p.sendStatusMessage(
					new TextComponentString(TextFormatting.AQUA + "Ice Dome: "
			...
			public boolean createJutsu(ItemStack stack, EntityLivingBase entity, float power) {
				// Creating the dome (cooldown applies)
				if (!entity.isRiding()) {
				...
				// Riding the dome (shoot spears) - NO cooldown
	...
	public static class Renderer extends EntityRendererRegister {
		...
		// NOTE: Your ModelDome class stays exactly the same as you pasted.
		@SideOnly(Side.CLIENT)
		public class ModelDome extends ModelBase {
			...
			public ModelDome() {
				// paste your full Blockbench constructor here (unchanged)
				textureWidth = 16;
				textureHeight = 16;
