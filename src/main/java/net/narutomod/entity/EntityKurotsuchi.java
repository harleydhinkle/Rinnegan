...
public class EntityKurotsuchi extends ElementsNarutomodMod.ModElement {
    ...
    public void initElements() {
        elements.entities.add(() -> EntityEntryBuilder.create()
                ...
                .id(new ResourceLocation("narutomod", "kurotsuchi"), ENTITYID)
                .name("kurotsuchi")
                .tracker(64, 3, true)
                .egg(-39271, -13108)
                .build());
    ...
    /**
     * SpongeForge-safe:
     * - NO inner renderer/model classes in EntityKurotsuchi.
     * - Just call a top-level client helper (same file, below).
     */
    @SideOnly(Side.CLIENT)
    @Override
    public void preInit(FMLPreInitializationEvent event) {
        EntityKurotsuchiClient.register();
    }
...
/* =======================================================================
 * CLIENT ONLY (same .java file, NOT an inner class)
 * This matches the base-jar pattern and prevents SpongeForge side crashes.
 * ======================================================================= */

@SideOnly(Side.CLIENT)
class EntityKurotsuchiClient {
    static void register() {
        net.minecraftforge.fml.client.registry.RenderingRegistry.registerEntityRenderingHandler(
                EntityKurotsuchi.EntityCustom.class,
                renderManager -> new net.minecraft.client.renderer.entity.RenderLiving(
                        renderManager,
                        new ModelBiped64slim(),
                        0.5F
                ) {
                    @Override
                    protected net.minecraft.util.ResourceLocation getEntityTexture(net.minecraft.entity.Entity entity) {
                        return new net.minecraft.util.ResourceLocation("narutomod:textures/kurotsuchi.png");
                    }
                }
        );
    }
 ...
 * Top-level client-only model (SpongeForge-safe).
 */
@SideOnly(Side.CLIENT)
class ModelBiped64slim extends net.minecraft.client.model.ModelBiped {
    public ModelBiped64slim() {
        ...
        this.bipedHeadwear.cubeList.add(new net.minecraft.client.model.ModelBox(this.bipedHeadwear, 32, 0,
                -4.0F, -8.0F, -4.0F, 8, 8, 8, 0.5F, false));
