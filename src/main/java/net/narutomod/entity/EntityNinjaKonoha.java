...
public class EntityNinjaKonoha extends ElementsNarutomodMod.ModElement {
    ...
    public void initElements() {
        elements.entities.add(() -> EntityEntryBuilder.create()
                ...
                .id(new ResourceLocation("narutomod", "ninja_konoha"), ENTITYID)
                .name("ninja_konoha")
                .tracker(64, 3, true)
                .egg(-16751053, -16764058)
                .build());
    }
    ...
    public void preInit(FMLPreInitializationEvent event) {
        EntityNinjaKonohaClient.register();
    }
...
@SideOnly(Side.CLIENT)
class EntityNinjaKonohaClient {
    static void register() {
        net.minecraftforge.fml.client.registry.RenderingRegistry.registerEntityRenderingHandler(
                EntityNinjaKonoha.EntityCustom.class,
                manager -> new net.minecraft.client.renderer.entity.RenderLiving<EntityNinjaKonoha.EntityCustom>(
                        manager,
                        new ModelNinjaKonohaBiped64(),
                        0.5F
                ) {
                    @Override
                    protected net.minecraft.util.ResourceLocation getEntityTexture(EntityNinjaKonoha.EntityCustom entity) {
                        return new net.minecraft.util.ResourceLocation("narutomod:textures/ninja_konoha.png");
                    }
                }
        );
    }
...
@SideOnly(Side.CLIENT)
class ModelNinjaKonohaBiped64 extends net.minecraft.client.model.ModelBiped {
    public ModelNinjaKonohaBiped64() {
