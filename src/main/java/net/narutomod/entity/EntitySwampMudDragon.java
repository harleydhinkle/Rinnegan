...
//System.out.println(s+", partRot:"+this.partRot);
	  	...
	  	protected void onImpact(RayTraceResult result) {
			if (result.entityHit != null && result.entity Hit.equals(this.shootingEntity))
				return;
		...
		public static class Jutsu implements ItemJutsu.IJutsuCallback {
			...
			public boolean createJutsu(ItemStack stack, EntityLivingBase entity, float power) {
				if (power >= 1.0f && entity.onGround
				 && (entity.isOverWater() || Chakra.pathway(entity).consume(ItemSwampRelease.SWAMPMUDDRAGON.chakraUsage * 2))) {
			...
			public void createJutsu(EntityLivingBase entity, float power) {
				entity.world.playSound(null, entity.posX, entity.posY, entity.posZ,
				  SoundEvent.REGISTRY.getObject(new ResourceLocation(("narutomod:swamp_release"))),
	...
	public static class Renderer extends EntityRendererRegister {
		...
		public class RenderDragon extends Render<EC> {
			...
			// Need to changed the png of the Dragon to fit Swamp Release
